...
namespace OutSystems.HubEdition.DatabaseProvider.MySQL.Platform.DatabaseObjects {
    public class MySQLPlatformDataTypeInfo : MySQLDataTypeInfo, IPlatformDataTypeInfo {

        public const int VARCHAR_MAXLENGTH = 2000;

        public MySQLPlatformDataTypeInfo(DBDataType type, string sqlDataType, int length, int decimals)
