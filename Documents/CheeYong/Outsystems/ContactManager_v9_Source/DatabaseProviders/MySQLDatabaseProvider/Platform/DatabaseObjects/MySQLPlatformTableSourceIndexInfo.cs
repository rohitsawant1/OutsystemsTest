...
namespace OutSystems.HubEdition.DatabaseProvider.MySQL.Platform.DatabaseObjects {
    public class MySQLPlatformTableSourceIndexInfo : IPlatformTableSourceIndexInfo {

        private readonly IList<IPlatformTableSourceColumnInfo> columns = new List<IPlatformTableSourceColumnInfo>();

        public MySQLPlatformTableSourceIndexInfo(ITableSourceInfo tableSource, string name, bool isUnique, bool isPrimaryKey) {           
