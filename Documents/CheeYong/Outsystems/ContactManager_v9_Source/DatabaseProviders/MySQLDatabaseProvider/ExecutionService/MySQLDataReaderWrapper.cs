...
namespace OutSystems.HubEdition.DatabaseProvider.MySQL.ExecutionService {
    ...
    /// </summary>
    internal class MySQLDataReaderWrapper : IDataReader {

        private readonly MySqlDataReader reader;
        private readonly MySQLExecutionService executionService;

        internal MySQLDataReaderWrapper(MySqlDataReader reader, MySQLExecutionService executionService) {
            this.reader = reader;
