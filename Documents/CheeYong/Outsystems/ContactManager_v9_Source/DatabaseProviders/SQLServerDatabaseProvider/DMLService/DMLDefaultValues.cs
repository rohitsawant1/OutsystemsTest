...
namespace OutSystems.HubEdition.DatabaseProvider.SqlServer.DMLService {
    public class DMLDefaultValues : BaseDMLDefaultValues {

        internal DMLDefaultValues(IDMLService dmlService) : base(dmlService) { }
        ...
        public override string Decimal {
            get {
                return "convert(decimal(" + DMLConstants.SQL_DIM_TO_DEC + "), 0)";
            }
        }
    }
}
