...
namespace OutSystems.HubEdition.DatabaseProvider.Oracle.Platform.Configuration {
    class BusinessDatabaseConfigurationManager : TwoUserDatabaseConfigurationManager {
        ...
        public override FileStream StreamForScriptFile {
            get {
                string path = Path.Combine(Script_Path, "business_model_oracle.sql");
        ...
        public override string ProcessStatement(string statement) {
            ...
            //statement = _osSystemDatabaseRegex.Replace(statement, this.systemDatabaseServiceName);
