...
namespace OutSystems.HubEdition.DatabaseProvider.Oracle.Platform.Configuration {
    ...
    public sealed class LoggingDatabaseConfiguration : TwoUserDatabaseConfiguration {
        public override string ConfigurationSufix { get { return "LOG"; } }
        ...
        public override void Set(IPlatformDatabaseConfiguration conf) {
            if (conf != null) {
                ...
                this.RuntimePassword = other.LogPassword;
                this.RuntimeTablespace = other.LogTablespace;
                this.RuntimeUser = other.LogUser;
