...
namespace OutSystems.HubEdition.DatabaseProvider.Oracle.Platform.Configuration {
    ...
    public abstract class TwoUserDatabaseConfiguration : BaseTwoUserDatabaseConfiguration {
        public enum NamingMethod { Service_Name, TNS_Name };

        public abstract string ConfigurationSufix { get; }
        public abstract string RuntimeTablespaceSufix { get; }
        ...
        public TwoUserDatabaseConfiguration() {
        ...
        public string AdminTablespace {
            get {
                return adminTablespace ?? "OSSYS_" + ConfigurationSufix;
            }
            set {
        ...
        public string IndexTablespace {
            get {
                return indexTablespace ?? "OSIDX_" + ConfigurationSufix;
            }
            set {
        ...
        public override string AdminUser {
            get {
                return adminUser ?? "OSADMIN_" + ConfigurationSufix;
            }
            set {
                adminUser = value;
            }
        ...
        public string RuntimeTablespace {
            get {
                return runtimeTablespace ?? RuntimeTablespaceSufix + "_" + ConfigurationSufix;
            }
            set {
        ...
        public override string RuntimeUser {
            get {
                return runtimeUser ?? "OSRUNTIME_" + ConfigurationSufix;
            }
            set {
                runtimeUser = value;
            }
...
Change the TNS configuration file at '/etc/outsystems/tnsnames.ora' to include the chosen TNS name.";
        ...
        public override bool Equals(ITwoUserDatabaseConfiguration obj) {
            ...
            var other = (TwoUserDatabaseConfiguration)obj;
        ...
        public override bool HasEmptyConfiguration() {
            return this.Host.IsNullOrEmpty() || this.ServiceName.IsNullOrEmpty();
        }
    }
}