...
namespace OutSystems.HubEdition.DatabaseProvider.Oracle.Platform.DatabaseObjects {
    public class PlatformTableSourceTriggerInfo : IPlatformTableSourceEventTriggerInfo {

        public PlatformTableSourceTriggerInfo(ITableSourceInfo tableSource, string name) {
