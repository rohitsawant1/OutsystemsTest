...
namespace ssContactManager.Flows.FlowRichWidgets {
	public abstract class WBlkRemovePopups: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.KbCSVaJcpZ0mjk1Rm1yvZwg";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("bCSVaJcpZ0mjk1Rm1yvZwg"); 
			}
		}
		...
		public bool if_wt_If5() {
			...
			try {
				heContext.CurrentESpaceKey = ssContactManager.Global.eSpaceKey;
				if_wt_If5_evalResult = ("InWebBlockPreview" == "True");
			} finally {
				heContext.CurrentESpaceKey = oldCurrentESpaceKey;
			}
			return if_wt_If5_evalResult;
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.KbCSVaJcpZ0mjk1Rm1yvZwg";
			}
		}
