...
namespace ssContactManager.Flows.FlowCommon {
	public abstract class WBlkLayout_Popup: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.KtsadIwkGZkeCoR4E8NXGQw";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("tsadIwkGZkeCoR4E8NXGQw"); 
			}
		}
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.KtsadIwkGZkeCoR4E8NXGQw";
			}
		}
	}
}
