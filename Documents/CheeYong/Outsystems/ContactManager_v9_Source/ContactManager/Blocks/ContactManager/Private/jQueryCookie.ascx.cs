...
namespace ssContactManager.Flows.FlowPrivate {
	public abstract class WBlkjQueryCookie: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.KK8UohFhyqk2lUYxTLg2D4w";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("K8UohFhyqk2lUYxTLg2D4w"); 
			}
		}
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.KK8UohFhyqk2lUYxTLg2D4w";
			}
		}
