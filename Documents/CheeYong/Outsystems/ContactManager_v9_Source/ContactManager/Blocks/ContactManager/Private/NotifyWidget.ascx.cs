...
namespace ssContactManager.Flows.FlowPrivate {
	public abstract class WBlkNotifyWidget: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		/// </summary>
		/// <summary>
		/// Screen Input Parameter inParamjavascriptVariableName. Description:
		/// </summary>
		public string inParamjavascriptVariableName = "";
		/// <summary>
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.KRF6PdJ7OV0e1T8YUqU0jPA";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("RF6PdJ7OV0e1T8YUqU0jPA"); 
			}
		}
		...
		/// <summary>
		/// Function to dump expression (Key = BXkx+ar1kkSKSc1L4I1Jrw) Expression: ""
		/// </summary>
		...
		/// <summary>
		/// Function to dump expression (Key = xY2THGkcCEy2YcnSG+VfXw) Expression: ""
		/// </summary>
		/// <returns>Returns the value of the Expression</returns>
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.KRF6PdJ7OV0e1T8YUqU0jPA";
			}
		}
	}
}
