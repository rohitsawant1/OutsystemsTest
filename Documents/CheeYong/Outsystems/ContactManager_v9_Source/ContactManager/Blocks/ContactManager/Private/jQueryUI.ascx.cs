...
namespace ssContactManager.Flows.FlowPrivate {
	public abstract class WBlkjQueryUI: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.KsAo76EKGEUSXZiPRUZOkdg";
		...
		private static void GetCssIncludes(TextWriter writer, HashSet<string> visited) {
			...
			CssHelper.WriteCssInclude(writer, AppUtils.Instance.getImagePath() + "Blocks/ContactManager/Private/jQueryUI.css" + AppUtils.Instance.CacheInvalidationSuffix);
		}
		...
		private static void GetInlineCss(TextWriter writer, HashSet<string> visited) {
			...
			string read;
			AppUtils.getResourceFileContent(out read, "Blocks\\ContactManager\\Private\\jQueryUI.css");
			localCss += OutSystems.HubEdition.RuntimePlatform.Email.EmailHelper.FlattenCSSFile(read, "Blocks\\ContactManager\\Private\\jQueryUI.css", cssVisited);
			writer.Write(localCss);
		}

		private static void InnerGetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			ssContactManager.Flows.FlowPrivate.WBlkjQueryBgiframe.GetCss(writer, inline, visited);
			ssContactManager.Flows.FlowPrivate.WBlkjQueryCookie.GetCss(writer, inline, visited);
			ssContactManager.Flows.FlowPrivate.WBlkjQueryCurvycorners.GetCss(writer, inline, visited);
			ssContactManager.Flows.FlowPrivate.WBlkjQueryDropshadow.GetCss(writer, inline, visited);
		}
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("sAo76EKGEUSXZiPRUZOkdg"); 
			}
		}
		...
		/// <summary>
		/// Function to dump expression (Key = 0m37X6nNSE+Eg0w0f3k14A) Expression: ""
		/// </summary>
		...
		public void webBlck_WebBlockInstance3_onDataBinding(object sender, System.EventArgs e) {
			...
			try {
				heContext.CurrentESpaceKey = ssContactManager.Global.eSpaceKey;
				ssContactManager.Flows.FlowPrivate.WBlkjQueryBgiframe widget = (ssContactManager.Flows.FlowPrivate.WBlkjQueryBgiframe) sender;
			} finally {
				heContext.CurrentESpaceKey = oldCurrentESpaceKey;
			}
		}
		public void webBlck_WebBlockInstance9_onDataBinding(object sender, System.EventArgs e) {
			...
			try {
				heContext.CurrentESpaceKey = ssContactManager.Global.eSpaceKey;
				ssContactManager.Flows.FlowPrivate.WBlkjQueryCookie widget = (ssContactManager.Flows.FlowPrivate.WBlkjQueryCookie) sender;
			} finally {
				heContext.CurrentESpaceKey = oldCurrentESpaceKey;
			}
		}
		...
		public void webBlck_WebBlockInstance4_onDataBinding(object sender, System.EventArgs e) {
			...
			try {
				heContext.CurrentESpaceKey = ssContactManager.Global.eSpaceKey;
				ssContactManager.Flows.FlowPrivate.WBlkjQueryDropshadow widget = (ssContactManager.Flows.FlowPrivate.WBlkjQueryDropshadow) sender;
			} finally {
				heContext.CurrentESpaceKey = oldCurrentESpaceKey;
			}
		}
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.KsAo76EKGEUSXZiPRUZOkdg";
			}
		}
