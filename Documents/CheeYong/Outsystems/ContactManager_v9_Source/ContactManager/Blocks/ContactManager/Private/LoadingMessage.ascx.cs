...
namespace ssContactManager.Flows.FlowPrivate {
	public abstract class WBlkLoadingMessage: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		/// </summary>
		protected OutSystems.HubEdition.WebWidgets.Container wtdivLoading;
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.Kgkua5Y_b5kWZMPnG_Hkbyg";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("gkua5Y+b5kWZMPnG+Hkbyg"); 
			}
		}
		...
		public void cntdivLoading_onDataBinding(object sender, System.EventArgs e) {
			ObjectKey oldCurrentESpaceKey = heContext.CurrentESpaceKey;
			try {
				heContext.CurrentESpaceKey = ssContactManager.Global.eSpaceKey;
				cntdivLoading_setInlineAttributes(sender, e);
			} finally {
				heContext.CurrentESpaceKey = oldCurrentESpaceKey;
			}
		}
		public string cntdivLoading_setInlineAttributes(object sender, System.EventArgs e) {
			ObjectKey oldCurrentESpaceKey = heContext.CurrentESpaceKey;
			try {
				heContext.CurrentESpaceKey = ssContactManager.Global.eSpaceKey;
				if (!cntdivLoading_isVisible()) {
		...
		/// <summary>
		/// Gets the visible state of component (wtdivLoading)
		/// </summary>
		/// <returns>The Visible State of wtdivLoading</returns>
		public bool cntdivLoading_isVisible() {
			ObjectKey oldCurrentESpaceKey = heContext.CurrentESpaceKey;
			try {
				heContext.CurrentESpaceKey = ssContactManager.Global.eSpaceKey;
				return true;
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.Kgkua5Y_b5kWZMPnG_Hkbyg";
			}
		}
	}
}
