...
namespace ssContactManager.Flows.FlowPrivate {
	public abstract class WBlkjQueryCurvycorners: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.KThp2Jx_S4UOSYbNCvDLUnA";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("Thp2Jx+S4UOSYbNCvDLUnA"); 
			}
		}
		...
		/// <summary>
		/// Gets the Height of the image (wt_Image6)
		/// </summary>
		/// <returns>Height of the Image (wt_Image6)</returns>
		public string img_Image6_actualHeight() {
			return HttpUtility.HtmlEncode(Convert.ToString(16));
		}
		/// <summary>
		/// Gets the Width of the image (wt_Image6)
		/// </summary>
		/// <returns>Width of the Image (wt_Image6)</returns>
		public string img_Image6_actualWidth() {
			return HttpUtility.HtmlEncode(Convert.ToString(16));
		}
		/// <summary>
		/// Function to dump expression (Key = SNOc9sWWjUGZuvoNf0D+Bg) Expression: ""
		/// </summary>
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.KThp2Jx_S4UOSYbNCvDLUnA";
			}
		}
