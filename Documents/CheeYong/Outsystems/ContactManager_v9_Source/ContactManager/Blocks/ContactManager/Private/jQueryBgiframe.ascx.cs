...
namespace ssContactManager.Flows.FlowPrivate {
	public abstract class WBlkjQueryBgiframe: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.KGlKWl2xOf0KFWw2Kbwnzpw";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("GlKWl2xOf0KFWw2Kbwnzpw"); 
			}
		}
		...
		/// <summary>
		/// Function to dump expression (Key = 2vjV0pbLA02v6uDjUtK83Q) Expression: ""
		/// </summary>
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.KGlKWl2xOf0KFWw2Kbwnzpw";
			}
		}
