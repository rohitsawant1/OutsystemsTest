...
namespace ssContactManager.Flows.FlowPrivate {
	public abstract class WBlkjQueryDropshadow: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "ContactManager.KvRSh6xP6WkuEJixXI_Qp_A";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("vRSh6xP6WkuEJixXI_Qp_A"); 
			}
		}
		...
		/// <summary>
		/// Function to dump expression (Key = x8ejnV5wHE+u3Fa2fRvtxg) Expression: ""
		/// </summary>
		...
		public override string WebBlockIdentifier {
			get {
				return "ContactManager.KvRSh6xP6WkuEJixXI_Qp_A";
			}
		}
