...
namespace OutSystems.HubEdition.WebWidgets {
    public abstract class TableCell : ViewStateSpecializations.ViewStateLessHtmlTableCell, IBreakPointControl, IAjaxHandler, IAjaxClickEvent, IGridWidget, IOSControl {

        protected TableCell(string tag) : base(tag) { }
