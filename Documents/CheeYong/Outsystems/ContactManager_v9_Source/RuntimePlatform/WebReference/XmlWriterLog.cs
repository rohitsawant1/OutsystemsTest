...
namespace OutSystems.HubEdition.RuntimePlatform.WebReference {
    public class XmlWriterLog : XmlWriter
    {
        private XmlWriter _me;
        private XmlTextWriter _bu;
        private StringWriter _sw;

        public XmlWriterLog(XmlWriter implementation, Encoding encoding)
        {
            _me = implementation;
            _sw = StringUtils.CreateStringWriter(encoding != null ? encoding : new UTF8Encoding(false));
        ...
        public override void WriteBase64(byte[] buffer, int index, int count) {
            _bu.WriteString("BINARY DATA");
            _me.WriteBase64(buffer, index, count);
        }
        ...
        public override void WriteStartElement(string prefix, string localName, string ns) {
            _me.WriteStartElement(prefix, localName, ns);
            _bu.WriteStartElement(prefix, localName, ns);
        }
